 ...
 * 수정 내용 : 
 *   - 20240916 / 없음
 *   - 20240927 / AES-192,256 암복호화가 가능하도록 매크로 상수 정의
 */
#ifndef _AES_H_
#define _AES_H_
...
#define Nk_192 6
#define Nr_192 12
#define RNDKEYLEN_192 (Nb*(Nr_192+1)) 52
#define KEYLEN_192 (4*Nk_192) 24

#define Nk_256 8  
#define Nr_256 14
#define RNDKEYLEN_256 (Nb*(Nr_256+1))
#define KEYLEN_256 (4*Nk_256)
